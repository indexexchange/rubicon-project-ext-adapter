...
var PartnerSpecificValidator = require('rubicon-project-ext-htb-validator.js');
 ...
 * @class
 */
function RubiconProjectExtHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'RubiconProjectExtHtb', // PartnerName
            namespace: 'RubiconProjectExtHtb', // Should be same as partnerName
            statsId: 'RUBIX', // Unique partner identifier
            version: '2.1.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
...
module.exports = RubiconProjectExtHtb;